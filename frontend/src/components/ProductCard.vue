<template>
  <div class="group bg-white rounded-2xl overflow-hidden card-hover border border-stone-100">
    <!-- Image -->
    <div class="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div v-else class="w-full h-full flex flex-col items-center justify-center">
        <div class="w-14 h-14 rounded-2xl bg-stone-200/60 flex items-center justify-center mb-2">
    ...
    <!-- Content -->
    <div class="p-5">
      <h3 class="font-semibold text-stone-900 text-base mb-1 truncate">{{ product.name }}</h3>
      ...
      <button
        ...
        class="w-full bg-brand-700 text-white py-3 rounded-xl hover:bg-brand-800 active:scale-[0.98]
               transition-all duration-200 font-medium flex items-center justify-center gap-2
               shadow-lg shadow-brand-700/15 hover:shadow-brand-700/25"
      >
