<template>
  <div class="min-h-screen bg-stone-100 flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="absolute top-1/3 -left-32 w-96 h-96 bg-brand-200/20 rounded-full blur-[100px]"></div>
    <div class="absolute bottom-1/4 -right-32 w-72 h-72 bg-brand-100/20 rounded-full blur-[80px]"></div>
